...
- 翻訳『リーダブルコード―より良いコードを書くためのシンプルで実践的なテクニック』オライリー・ジャパン（2012-06-23）24刷
...
- [“手法の戦争”と“手法の監獄”から抜け出す　ソフトウェア開発の本質を捉えるEssenceとは - ログミーTech](https://logmi.jp/tech/articles/324109)（2021-03-24）
