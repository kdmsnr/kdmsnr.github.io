...
* 冊数が多いので → [Amazon.co.jp 著者ページ](https://www.amazon.co.jp/-/e/B00429JIAI/)

### 雑誌

- Ruby徹底攻略「はじめてのRuby」
- WEB+DB PRESS Vol.38「はじめてのRuby & Rails」
- Life Hacks PRESS「はじめてのマインドマップ」
- 日経ソフトウエア 2006/01号「FreeMind「思考」を記録するマインド・マップ作成ソフト」
